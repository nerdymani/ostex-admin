...
.btn-sec{background:#0c214f}.btn-sec:hover{background:#0a1c43}
...
<?php elseif ($step === 'configure'): ?>
  ...
  <form method="POST">
    ...
    <div class="form-group"><label>Admin Password</label><input name="ADMIN_PASSWORD" type="password" value="" required></div>
...
<?php elseif ($step === 'success'): ?>
  ...
  <div style="text-align:center"><a href="/admin" class="btn btn-sec">Go to Admin Panel →</a></div>
